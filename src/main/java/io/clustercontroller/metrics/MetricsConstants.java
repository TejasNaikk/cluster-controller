...
public class MetricsConstants {
    ...
    // Doc count metrics
    public final static String SHARD_PRIMARY_DOC_COUNT_METRIC_NAME = "shard_primary_doc_count";
    public final static String SHARD_REPLICA_DOC_COUNT_METRIC_NAME = "shard_replica_doc_count";
    public final static String SHARD_PRIMARY_DELETED_DOC_COUNT_METRIC_NAME = "shard_primary_deleted_doc_count";
    ...
    public final static String NODE_NAME_TAG = "nodeName";
